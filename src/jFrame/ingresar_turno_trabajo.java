 ...
 */
public class ingresar_turno_trabajo extends javax.swing.JFrame {

    /**
     * Creates new form ingresar_turno
     */
    public ingresar_turno_trabajo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ingresar_turno_trabajo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ingresar_turno_trabajo().setVisible(true);
            }
        });
    }
