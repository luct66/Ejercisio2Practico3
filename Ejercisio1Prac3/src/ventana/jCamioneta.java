...
import principal.Camioneta;

/**
 *
 * @author Administrador
 */
public class jCamioneta extends javax.swing.JFrame {
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
       Camioneta nuevo = new Camioneta(40,"Ford","L4UT1",0,"Alquiler");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jCamioneta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jCamioneta().setVisible(true);
            }
        });
    }
